...
C_SRCS += \
../User/SM2/storagemanager.c 

OBJS += \
./User/SM2/storagemanager.o 

C_DEPS += \
./User/SM2/storagemanager.d 


# Each subdirectory must supply rules for building sources it contributes
User/SM2/%.o User/SM2/%.su User/SM2/%.cyclo: ../User/SM2/%.c User/SM2/subdir.mk
...
clean: clean-User-2f-SM2

clean-User-2f-SM2:
	-$(RM) ./User/SM2/storagemanager.cyclo ./User/SM2/storagemanager.d ./User/SM2/storagemanager.o ./User/SM2/storagemanager.su

.PHONY: clean-User-2f-SM2
