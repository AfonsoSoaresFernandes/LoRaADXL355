...
C_SRCS += \
../User/Flash_Interface/flash_interface.c 

OBJS += \
./User/Flash_Interface/flash_interface.o 

C_DEPS += \
./User/Flash_Interface/flash_interface.d 


# Each subdirectory must supply rules for building sources it contributes
User/Flash_Interface/%.o User/Flash_Interface/%.su User/Flash_Interface/%.cyclo: ../User/Flash_Interface/%.c User/Flash_Interface/subdir.mk
...
clean: clean-User-2f-Flash_Interface

clean-User-2f-Flash_Interface:
	-$(RM) ./User/Flash_Interface/flash_interface.cyclo ./User/Flash_Interface/flash_interface.d ./User/Flash_Interface/flash_interface.o ./User/Flash_Interface/flash_interface.su

.PHONY: clean-User-2f-Flash_Interface
