...
typedef enum
{
  ...
  CFG_SEQ_Task_LoRaReceivedMsgEvent,

  // --------------- SCHEDULED ------------------
  CFG_SEQ_Task_ScheduledADXL355ReadEvent_Config,
  CFG_SEQ_Task_ScheduledADXL355ReadEvent_Read,
  CFG_SEQ_Task_ScheduledADXL355ReadEvent_Process,
  ...
  // --------------- TILT ------------------
  CFG_SEQ_Task_TiltADXL355ReadEvent,
